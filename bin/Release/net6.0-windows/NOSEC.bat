...
:: Hide the "Firewall and network protection" area from Windows Defender Security Center
echo --- Hide the "Firewall and network protection" area from Windows Defender Security Center
...
:: ----------------------------------------------------------
:: Set minimum time for keeping files in scan history folder-
:: ----------------------------------------------------------
echo --- Set minimum time for keeping files in scan history folder
...
:: ----------------------------------------------------------
:: ---Prevent saving zone information in downloaded files----
:: ----------------------------------------------------------
echo --- Prevent saving zone information in downloaded files
reg add "HKLM\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\Attachments" /v "SaveZoneInformation" /t REG_DWORD /d "1" /f
:: ----------------------------------------------------------


:: ----------------------------------------------------------
:: -Prevent notifying antivirus programs of downloaded files-
:: ----------------------------------------------------------
echo --- Prevent notifying antivirus programs of downloaded files
